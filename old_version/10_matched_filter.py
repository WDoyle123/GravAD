...
@jit
def matched_filter(template_fs, data_fs,  psd, fs, delta_f, f_l, f_u, freq_bins, sampling_rate):
    """
...
def main():
    ...
    snr = matched_filter(template_jax, fdata_jax, inverse_psd_jax, freqs, delta_f, low_freq, high_freq, freq_bins, sampling_rate)
